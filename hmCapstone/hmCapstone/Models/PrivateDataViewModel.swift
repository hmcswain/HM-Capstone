...
class PrivateDataViewModel: ObservableObject {
  @Published var dateOfBirth = UserDefaults.standard.string(forKey: "dateOfBirth") ?? ""
  ...
  private func isValidPhone(_ phone: String) -> Bool {
    ...
    let phonePattern = "^[0-9+]{10,13}$"  // Adjust regex according to your needs
...
class PrivateDataViewModel: ObservableObject {
    ...
    init() {
        // Load or set default date of birth
